...
/**
 * Applies the step middle interpolation algorithm to the given coordinates to generate an array with the requested length.
 */
export class StepMiddleInterpolator extends AbstractInterpolator {
